...
export const getReporteAntiguedad = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const result = await reporteExperimentalDB.getAntiguedadEstudiante(limit, offset);
    console.log(result)

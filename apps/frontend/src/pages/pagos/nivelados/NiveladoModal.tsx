...
import FormularioNivelado from "./FormularioNivelado" // Asegúrate de tener este componente

const fontFamily =
  "'Nunito', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif"

interface NiveladoModalProps {
  open: boolean
  onClose: () => void
...
const NiveladoModal: React.FC<NiveladoModalProps> = ({ 
  open, 
  onClose, 
  niveladoId, 
  isEditing = false 
    ...
    >
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center" }}>
          ...
          >
            {isEditing ? "Editar Nivelado" : "Registrar Nivelado"}
          </Typography>
        </Box>
